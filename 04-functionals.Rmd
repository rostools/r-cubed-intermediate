...
use instead. And while technically, using a loop lets you "not repeat
yourself", it's a lot of typing and code to express a simple idea: *Do an action
on each of these items*. So using functionals lets you repeat yourself 
less `r emo::ji("smile")`
...
TODO: This doesn't use user_id, so need to change later code to use file_path_id
