...
We've covered quite a bit in this course and you've (hopefully) learned
a lot. Before moving on to other exercises, discuss with your group how
you might use this workflow (or parts of it) in your own work. What are
some ways you might use these workflows and techniques? What challenges
do you see might come up by using these skills and tools? Groups will
briefly share what they've discussed before moving on to the other
exercises. (side note: this exercise is partly to help reinforce what
you've learned and also partly selfish since we'd love to hear how you
might use these tools and some challenges that might come up by using
them.)
