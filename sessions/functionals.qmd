...
Inside the `data-raw/mmash.R` script, copy and paste these two lines of
code to the bottom of the script. Afterwards, go the top of the script
and right below the `library(here)` line at the top of the script, add
these two lines of code, so it looks like this:
