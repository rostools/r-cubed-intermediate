...
Before we continue, let's clean up the `docs/learning.qmd` file by
...
for you and for us as teachers). And because we use Git, nothing is
...
<!-- TODO: Delete the text about the library(fs), since that will be fixed after the workshop -->
