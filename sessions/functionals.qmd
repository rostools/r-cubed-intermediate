...
do many things at once with minimal extra code. Remember what we said:
"If you can do it for one, you can do it for all". This is the part
where we "do it for all".
...
- Can use functions as input to other functions to then use that
  function on each item in a set of items (called a
...
::: {.callout-note collapse="true" appearance="minimal" title="**Click for the solution**. Only click if you are struggling or are out of time."}
```{r}
#| label: extra-solution-read-all-max-rows
#| output: false
#| eval: false
...
::: {.callout-note collapse="true" appearance="minimal" title="**Click for the solution**. Only click if you are struggling or are out of time."}
```{r}
#| label: extra-solution-data-dir-global-var
#| eval: false
#| output: false
