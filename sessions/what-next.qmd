...
you can join our
[r-cubed Discord server](https://discord.gg/xHPyj7dxJx).

::: {.callout-tip appearance="minimal"}
:star: Do you find this course material useful? Then please consider
"starring" our
[GitHub repository](https://github.com/rostools/r-cubed-intermediate/)
to show your support! Starring will save it to a list of repositories
you like that you can easily find again, plus it helps give our project
more visibility!
:::
