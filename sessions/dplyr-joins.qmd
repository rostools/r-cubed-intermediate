...
Go into the `docs/learning.qmd` and cut the code used to create the
...
workshop) save it as a `.csv` file with:
...
data is with `load(here::here("data/mmash.rda"))`. Lastly, **add and commit** 
