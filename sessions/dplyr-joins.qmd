...
3.  Replace the code in the `doc/learning.qmd` file with the function
    ...
    works.
4.  Knit / render the `doc/learning.qmd` file to make sure things remain
    reproducible with {{< var keybind.render >}}.
5.  Add and commit the changes to the Git history with
    {{< var keybind.git >}}.
