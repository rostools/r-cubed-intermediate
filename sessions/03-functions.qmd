...
Here we will cover the second block, "*Workflow*" in Figure
@fig-diagram-overview-2.

![Section of the overall workflow we will be
covering.](/images/diagram-overview-2.svg){#fig-diagram-overview-2}

And your folder and file structure should look like (use
...
<!-- TODO: Use styler throughout course? -->
...
working function, let's **add and commit** it to the Git history with
the RStudio Git Interface by using {{< var keybind.git >}}.
