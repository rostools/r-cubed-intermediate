...
nurses' stress dataset into a function. Now, let's modify it so that we
can also test out reading in different number of rows so we don't have
to keep changing the `n_max` value inside of the function.
