...
3. Paste the code you used from the exercise in
   ...
   - End the function with using `return()` to output the `sleep`
     object.
   - Use the function and run it in the code chunk to test that it works
     on both `101` and `102`'s sleep data.
   - Add the Roxygen documentation with {{< var keybind.roxygen >}} and
     then fill in the details, like we did above.
