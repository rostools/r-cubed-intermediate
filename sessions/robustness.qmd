...
documents or R scripts means it needs to be robust and accessible enough
...
```{r}
#| label: admin-print-desc-add-here
#| echo: false
#| comment: ""
...
```{r}
#| label: admin-use-packages-tidyverse
#| echo: false
#| error: true
...
```{r}
#| label: use-package-tidyverse-depends
#| filename: "Console"
#| eval: false
...
```{r}
#| label: admin-use-packages-tidyverse-depends
#| echo: false
...
```{r}
#| label: admin-print-desc-add-tidyverse
#| echo: false
#| comment: ""
...
that come from base R, use `package_name::function_name()`.
...
You add `{readr}` and `{snakecase}` to the `DESCRIPTION` file with:
...
And you update the function to look like this:
...
3. Then, as a group, we will briefly share some of the things you
   thought about and discussed with your neighbour.
