...
2. Take 3 minutes to discuss with your neighbour what you think could be
   done to make it more general-purpose and try to come to a conclusion.
3. Then all together and in the remaining time, everyone will share what
   they've thought of.
...
3. There is one other package we've used that we haven't added to the
   ...
   file from the menu. In that file, find the package we used and add it
   to the `DESCRIPTION` file using `usethis::use_package()` in the
   **Console**.
