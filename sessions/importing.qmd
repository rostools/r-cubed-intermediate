...
space and the folder naming scheme is `<id>_<Epoch timestamp>`.
[Epoch timestamp](https://en.wikipedia.org/wiki/Unix_time) is a way to
...
case is recommended in the
[tidyverse style guide](https://style.tidyverse.org/) and there's even a
package called `{snakecase}` that can help us with this!
