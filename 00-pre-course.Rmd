...
have these learning objectives defined:
...
Please read all of 
[Section 6.1](https://r-cubed.rostools.org/r-project-management.html#what-is-a-project-and-why-use-it)
...
sleep and activity (MMASH) [@Rossi2020]. Look over these tasks and than switch 
over to the [MMASH website][mmash-website]:

1. Look through the Data Description to familiar with the dataset and see what
...
So you can sometimes encounter problems with finding files. So instead, when you use
