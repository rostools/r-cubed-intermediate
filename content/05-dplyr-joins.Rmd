...
source_session(here("content/04-functionals.Rmd"))
```
...
- Knit the `doc/lesson.Rmd` file to make sure things remain reproducible.
...
Go into the `doc/lesson.Rmd` and cut the code used to create the
...
with `load(here::here("data/mmash.rda"))`. Go into the `doc/lesson.Rmd` file 
