...
- Some personal experiences, if you have any, you have had where the lack of
explicit dependencies made your work harder and more confusing.

All groups will briefly share their own thoughts.
...
to the `data-raw/mmash.R` script and then *completely* clean up the R Markdown.
Open up the `data-raw/mmash.R` script, go to the very bottom of the script,
and let's add the importing functions to the script:
