...
this task can take the longest because you have to contact your IT to install this
packages.
...
1. Writing R code to download the data and save it to your computer. This task
will probably take up most of the time, maybe 30-60 minutes.
1. Run a check to see that everything is as expected (you'll later need to paste
...
so it's at least a little usable, and than save it to your computer.
