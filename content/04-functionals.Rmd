...
To test that things work, let's knit the R Markdown document (`Ctrl-Shift-K`).
If it works, then we can move on and open up the `data-raw/mmash.R` script. Inside
the script, add these two lines of code to the bottom of the script. Afterwards,
go the top of the script and right below the `library(here)` code, add these two
