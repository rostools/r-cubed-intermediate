...
For this course, we'll be using an openly licensed dataset on monitoring sleep
and activity (MMASH) [@Rossi2020]. A couple of things

https://physionet.org/content/mmash/1.0.0/

Jump down to data description
...
user_1_saliva_data <- vroom(
    ...
    # ibi_s = inter_beat_interval_seconds
