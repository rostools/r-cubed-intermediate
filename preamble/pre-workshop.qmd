...
**4-6 hrs to finish**, so we suggest planning a full day to complete
...
Since Git has already been covered in the Introduction workshop, we won't
...
1.  Follow the [pre-workshop tasks for
    Git](https://r-cubed-intro.rostools.org/preamble/pre-workshop.html#setting-up-git-and-github)
    (*not* the GitHub tasks) from the introduction workshop. Specifically,
...
2.  **Please read** through the [Version Control
    ...
    of the introduction workshop. *You don't need to do any of the
    exercises or activities*, but you are welcome to do them if it will
    help you learn or understand it better. For most of the workshop, we
