...
8.  Run a check to see that everything is as expected
    -   You'll later need to paste this output into the survey.
9.  Read the syllabus (@sec-syllabus).
10. Read the [Code of
...
<!-- TODO: Move this into guides repo -->
...
-   Sometimes functions have their package name appended with `::` to
    ...
    `pak::pkg_install()`. You'll learn about this more later.
...
> R or RStudio, if you have at least 4.0.0 for R and at least 1.4 for
> RStudio, that should be fine. If you have versions of R and RStudio
> older than that, it is necessary for you to request that IT update
> your software if you can't yourself. Unfortunately, given that Git is
> not a commonly used software for some organizations, you may not have
> it installed and you *will* need to ask IT to install it. We *require*
> it for the course, so please make sure to give IT enough time to be
> able to install it for you.
