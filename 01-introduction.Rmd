...
- Slide? Motivation, why use these (short lecture?)
    - Motivation: When I started I always wondered *how* do people go about
    doing data analysis... what was there workflow exactly like. No one ever
    really taught that, and even on internet tutorials it mostly taught 
    individual code chunks and taught how to use that.. but never showing the
    bigger picture. That's why with this course and partly with the beginner one,
    I tried to focus on the bigger picture and the overall workflow you would
    do for data analysis. 
...
"Debug" menu items. The interface should open up
